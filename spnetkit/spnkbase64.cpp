...
SP_NKBase64EncodedBuffer :: SP_NKBase64EncodedBuffer( const void * plainBuffer, size_t len )
{
	mLength = len * 4 / 3 + 16;
...
SP_NKBase64EncodedBuffer :: ~SP_NKBase64EncodedBuffer()
{
	free( mBuffer );
	mBuffer = NULL;
}

const char * SP_NKBase64EncodedBuffer :: getBuffer()
{
	return mBuffer;
}

size_t SP_NKBase64EncodedBuffer :: getLength()
{
	return mLength;
}
...
SP_NKBase64DecodedBuffer :: SP_NKBase64DecodedBuffer( const char * encodedBuffer, size_t len )
{
	mLength = len * 3 / 4 + 16;
	mBuffer = (char*)malloc( mLength );
	memset( mBuffer, 0, mLength );
...
SP_NKBase64DecodedBuffer :: ~SP_NKBase64DecodedBuffer()
{
	free( mBuffer );
	mBuffer = NULL;
}

const void * SP_NKBase64DecodedBuffer :: getBuffer()
{
	return mBuffer;
}

size_t SP_NKBase64DecodedBuffer :: getLength()
{
	return mLength;
}
